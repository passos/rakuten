package com.rakuten.assessment.utils;
...
//                        WpkLogUtil.i(tagPrefix + tag, line);
//                        break;
//                    case android.util.Log.DEBUG:
//                        WpkLogUtil.d(tagPrefix + tag, line);
//                        break;
//                    case android.util.Log.WARN:
//                        WpkLogUtil.w(tagPrefix + tag, line);
//                        break;
//                    case android.util.Log.ERROR:
//                        WpkLogUtil.e(tagPrefix + tag, line);
//                        break;
//                    case android.util.Log.VERBOSE:
//                        WpkLogUtil.v(tagPrefix + tag, line);
//                        break;
//                    default:
//                        android.util.Log.println(priority, tagPrefix + tag, line);
//                }
